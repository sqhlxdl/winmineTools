...
namespace winmineTools
{
    ...
    public class Mem
    {
        ...
        public int ShowWindow(int nCmdShow = 3)
        {
            return ShowWindow(theProc.MainWindowHandle, nCmdShow);
        }
        ...
        public bool SetFocus(int nCmdShow = 3)
        {
            ShowWindow(nCmdShow);
           ...
           return SetForegroundWindow(theProc.MainWindowHandle);
        }

        public int GetWindowSize( out Rect lpRect)
        {
            return GetWindowRect(theProc.MainWindowHandle,out lpRect);
        }
        ...
        public Process[] GetProcessesByName(string processName)
        {
            ...
            try
            {
                localByName = Process.GetProcessesByName(processName);
            }
            catch (Exception)
            {
                localByName = null;
